# Generated by Powerlevel10k configuration wizard on 2022-02-16 at 14:16 AEDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context                 # user@hostname (now user only)
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=142
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=35
  ...
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=17
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n'  # previously: '%n@%m'
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=130
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=91
